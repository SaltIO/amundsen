...
export const AWSS3_LOGO_PATH = '/static/images/aws_s3.png';
export const SNOWFLAKE_LOGO_PATH = '/static/images/snowflake.png';
export const MYSQL_LOGO_PATH = '/static/images/mysql.png';
