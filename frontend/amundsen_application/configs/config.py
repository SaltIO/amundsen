...
class FrontendConfigAuth(OidcConfig):
    if 'ISSUE_TRACKER_URL' in os.environ:
        ...
        ISSUE_TRACKER_ISSUE_TYPE_ID = os.environ.get('ISSUE_TRACKER_ISSUE_TYPE_ID', 10002) # type: int (Jira only: Override default issue tracker ID whenever needed for cloud/hosted deployments)
